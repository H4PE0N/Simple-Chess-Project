...
#ifndef SCREEN_COLOR_DEFINES_H
#define SCREEN_COLOR_DEFINES_H

#define GRID_WHITE_COLOR (Color) {225, 225, 225}
#define GRID_BLACK_COLOR (Color) {30, 30, 30}
...
#define BOARD_MOVE_COLOR (Color) {0, 255, 00}
