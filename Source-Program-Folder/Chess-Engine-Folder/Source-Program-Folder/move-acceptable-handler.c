...
//
// /*
// Why this sort of functions exists, is becuase if there are more
// than one type of move a piece can do. For exemple, the rook can
// do a special move with the king, called a castle. That is a whole
// another operation than its usual move.
// */
